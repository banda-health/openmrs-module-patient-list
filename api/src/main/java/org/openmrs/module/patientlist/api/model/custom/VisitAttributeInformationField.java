...
/**
 * Define {@link VisitAttributeInformationField} operators
 */
public class VisitAttributeInformationField<T extends OpenmrsData>
        extends AbstractPatientListField<T, String> {
	private String attributeName;

	public VisitAttributeInformationField(
	...
	public String equalOperator(String searchValue) {
		...
		hql.append(" vattrType.name = ? AND vattr.voided != true AND vattr.valueReference ");
